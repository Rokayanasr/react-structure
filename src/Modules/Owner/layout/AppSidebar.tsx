...
const navItems: NavItem[] = [
    ...
    {
        icon: <BagIcon />,
        name: "Arbeisangebote erstellen",
        path: "/create-job-offer",
    },
    {
        icon: <TimeIcon />,
        name: "Noch offene Jobs",
        path: "/job-offers",
    },
    {
        icon: <CcoinIcon />,
        name: "Festanstellung erstellen",
        path: "/create-permanent-job",
    },
    {
        icon: <ListIcon />,
        name: "NPM",
        path: "/create-non-pharmacy-job",
    },
    {
        icon: <DollarLineIcon />,
        name: "Preisliste",
    ...
    //         { name: "Blank", path: "/blank", pro: false },
    //     ],
    // },
    // {
    //     icon: <CalenderIcon />,
...
const AppSidebar: React.FC = () => {
    ...
    return (
        ...
        lg:translate-x-0`}
            ...
            {/* {isExpanded || isHovered || isMobileOpen ? <SidebarWidget /> : n */}
            </div>
        </aside>
    );
};
